                        ...
                        <div className={classes.mainTextContainerLeft}>
                            ...
                            <div className={classes.mainTextLeft}>
                                ...
                                <Typography className={classes.textLeft}>
                                    ...
                                    <p>
                                        A Michigan resident must meet basic requirements to obtain a Michigan concealed weapons permit, for example:
                                        <ol>
                                            ...
                                            <li>Have knowledge and training in the safe use and handling of a pistol by successfully completing an appropriate pistol safety training course or class.</li><br></br>
                                            ...
                                            <li>Have not been convicted of a misdemeanor in the eight years immediately preceding the date of the application for a Michigan concealed weapons permit, or have a pending charge for a misdemeanor at the 
