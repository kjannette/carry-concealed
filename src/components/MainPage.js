                        ...
                        <div className={classes.mainTextContainerLeft}>
                            ...
                            <div className={classes.mainTextLeft}>
                                ...
                                <Typography className={classes.textLeft}>
                                    ...
                                    <p> <b>Welcome to your best starting point for information about concealed weapons permits. </b>Read on on for general information you should know, or head right to concealed weapons permit information <Link to="/map" className={classes.link}>by state.</Link></p>
