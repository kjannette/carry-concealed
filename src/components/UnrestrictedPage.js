                    ...
                    <div className={classes.mainTextContainerLeft}>
                        ...
                        <div className={classes.mainTextLeft}>
                            ...
                            <Typography className={classes.textLeft}>
                                ...
                                <p>These states allow permitless carrying a concealed weapon by individuals (limtied to those who are not otherwise prohibited from owning a firearm) in any place not otherwise deemed off-limits by law.</p> 
                                ...
                                <p>Both open carry and concealed carrying of a wepon are legal in Vermont.</p>
